...
"""
Plan:
1. Translate the provlem into graph terminology
vertex - user
...
each user has a directed edge to its ancestor/parent

3. Traverse the graph
traverse all paths starting from starting_node,
keep track of furthest node found with the lowest user id
